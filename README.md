...
This is the default template for new frontends. It uses Vite, TypeScript, React, our shared components and utilities,
and all the other goodies.

⚠️It's recommended you don't directly clone this repository, but use the [create-frontend](https://github.com/rio-cloud/create-frontend)
CLI instead, as this will automatically ask you for the correct values to fill in the template.

Once that's done, remove this section and write your own README 🦄

_Even though it's technically ignored, please make sure to update the list of OAuth scopes in [src/](src/config.ts)._
...
- **src**
    ...
    - **pages**: The folder for all navigable service pages. Pages are composed of features and components. For the
      ...
      as routes. But this could also be subpages in some cases.
